...
function ZoskronUI:CreateWindow(options)
    ...
    function window:AddTab(tabName, iconName)
        ...
        if iconName and ZoskronUI.Icons[iconName] then
            local icon = Instance.new("ImageLabel")
            icon.Size = UDim2.new(0, 24, 0, 24)
            icon.Position = UDim2.new(0, 8, 0.5, -12)
            icon.BackgroundTransparency = 1
            icon.Image = ZoskronUI.Icons[iconName]
            icon.Parent = tabBtn
            tabBtn.Text = "   " .. tabName
        end
        ...
        tabBtn.MouseButton1Click:Connect(function()
            if currentTabFrame then
                ...
                currentTabFrame.Button.BackgroundColor3 = CurrentTheme.Background
                currentTabFrame.Button.TextColor3 = CurrentTheme.TextSecondary
            end
            tabContent.Visible = true
            tabBtn.BackgroundColor3 = CurrentTheme.Accent
            tabBtn.TextColor3 = CurrentTheme.Text
            currentTabFrame = {Visible = true, Button = tabBtn, Frame = tabContent}
        end)
